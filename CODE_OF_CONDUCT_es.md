...
## Agradecimientos
Este Código de Conducta está basado en la versión anterior, e incorpora ideas de nuestra valiosa comunidad. Su versión en inglés ha sido revisada por los miembros del equipo de Epiverse: Hugo Gruson, Chris Hartgerink, Karim Mane, Joshua Lambert, Andree Valle-Campos, James Mba Azam, y Diana Fajardo Pulido y un revisor externo Paul Korir, Director of Data Science, data.org para garantizar que siga siendo inclusiva, clara y eficaz. Esta traduccion al espanol ha sido revisada por Andree Valle-Campos, Laura Gómez y Diana Fajardo Pulido

Este Código de Conducta también se inspira en las políticas de rOpenSci y NHS-R Community que se han adaptado de muchas fuentes, incluidas Open Source and Feelings talk de Audrey Eschright, el borrador del Grupo de Trabajo sobre Diversidad e Inclusión de la Comunidad del Consorcio R Code of Conduct, Geek Feminism anti-harassment policy, useR! 2021 Code of Conduct, Convocatoria de la Comunidad ropenSci: How do I create a Code of Conduct for my event/lab/codebase? y The Turing Way Code of Conduct. Originalmente el Código de Conducta de Epiverse-TRACE estaba inspirado en RECON and CSCCE. Agradecemos a estas comunidades su compromiso con la diversidad, la equidad y la inclusión. La facilidad para elaborar este exhaustivo Código de Conducta se debe al reconocido trabajo que se está publicando en el marco del Creative Commons Attribution 4.0 International (CC BY 4.0 CA). 
